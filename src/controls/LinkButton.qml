...
/*!
  ...
  This component should mostly not be used; prefer an actual button to navigate
  within the app or trigger actions, and prefer a \l UrlButton to display a link
  to a web site or other remote resource. See also
  \l https://develop.kde.org/hig/layout_and_nav/#navigation
